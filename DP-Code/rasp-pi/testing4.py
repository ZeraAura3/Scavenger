...
def capture_image():
    ...
    subprocess.run(["libcamera-still", "-o", image_path,"--width","1280","--height","720","-t","2000"])
...
def main():
    ...
    while True:
        ...
        # Log or handle based on classification
        #if classification == "biodsegradable":
           # print("Biodegradable waste detected. Opening the appropriate bin...")
           # arduino.write("Biodegradable waste detected. Opening the appropriate bin...".encode('utf-8')
       # else if classification == "non-biodegradable":
           # print("Non-biodegradable waste detected. Opening the appropriate bin...")
           # arduino.write("Non-biodegradable waste detected. Opening the appropriate bin...".encode('utf-8')
        #else:
            #print("Classification unknown. Please check the waste item.")
           # arduino.write("Classifsication unknown. Please check the waste item.").encode('utf-8')
