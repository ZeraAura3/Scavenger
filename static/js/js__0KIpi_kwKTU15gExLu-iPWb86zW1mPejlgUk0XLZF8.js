      ...
      $('.js-webform-unsaved button, .js-webform-unsaved input[type="submit"]', context)
        ...
        .on('click', function (event) {
          ...
          if ($(this).hasClass('webform-button--reset') && unsaved) {
            if (!window.confirm("Make sure to save draft before leaving the page. Data may get lost if continued without saving.")) {
              return false;
            }
          }
...
(function ($, Drupal) {
  ...
  //   var message = Drupal.t('Make sure to save draft before leaving the page. Data may get lost if continued without saving.') +
  //     '\n' +
